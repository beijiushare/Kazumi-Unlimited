...
class _InfoPageState extends State<InfoPage> with TickerProviderStateMixin {
  ...
  late BangumiItem inputBangumiIten;
  late bool isHardSearch;
  late String? hardSearchKeyword;
  ...
  void initState() {
    ...
    // 检查是否为硬搜索模式
    if (args is Map) {
      isHardSearch = args['isHardSearch'] ?? false;
      hardSearchKeyword = args['keyword'];
      // 创建一个临时的BangumiItem用于硬搜索
      inputBangumiIten = BangumiItem(
        id: 0,
        type: 2,
      ...
      isHardSearch = false;
      hardSearchKeyword = null;
      inputBangumiIten = args as BangumiItem;
    }
