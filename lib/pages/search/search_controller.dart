...
abstract class _SearchPageController with Store {
  ...
  @observable
  late bool hardSearchMode = _collectRepository.getSearchHardSearchMode();
  ...
  @action
  Future<void> setHardSearchMode(bool value) async {
    hardSearchMode = value;
    await _collectRepository.updateSearchHardSearchMode(value);
  }
