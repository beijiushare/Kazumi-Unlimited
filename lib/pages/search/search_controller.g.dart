...
mixin _$SearchPageController on _SearchPageController, Store {
  ...
  late final _$hardSearchModeAtom =
      Atom(name: '_SearchPageController.hardSearchMode', context: context);

  @override
  bool get hardSearchMode {
    _$hardSearchModeAtom.reportRead();
    return super.hardSearchMode;
  }

  bool _hardSearchModeIsInitialized = false;

  @override
  set hardSearchMode(bool value) {
    _$hardSearchModeAtom.reportWrite(
        value, _hardSearchModeIsInitialized ? super.hardSearchMode : null, () {
      super.hardSearchMode = value;
      _hardSearchModeIsInitialized = true;
    });
  }
  ...
  late final _$setHardSearchModeAsyncAction =
      AsyncAction('_SearchPageController.setHardSearchMode', context: context);

  @override
  Future<void> setHardSearchMode(bool value) {
    return _$setHardSearchModeAsyncAction
        .run(() => super.setHardSearchMode(value));
  }
